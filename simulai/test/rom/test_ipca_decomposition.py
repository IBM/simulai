...
class TestIPCADecomposition(TestCase):
    ...
    def test_2D_separable_dataset(self) -> None:
        ...
        for batch_size in batch_sizes:
            ...
            with make_temp_directory() as tmp_dir:
                with h5py.File(os.path.join(tmp_dir, f'test_data_{batch_size}.h5'), 'w') as fp:
    ...
    def _exec_IPCA_tests(self, dataset, N_components, batch_size, save_path) -> None:
        ...
        for n_components in N_components:
            ...
            pipeline = Pipeline(stages=[('data_preparer', ByPassPreparer(channels_last=True)),
            ...
            print(f"PCA projection error for one-dimensional case performed with {n_components} components: {100*error} %.")
