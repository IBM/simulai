...
def view_api(module:torch.nn.Module=None,
             input_data: Union[torch.nn.Module, np.ndarray]=None,
             config:Dict=None, save_dir:str=None):

    try:
        from torchview import draw_graph
    except Exception:
        raise Exception("For using the visualization API,\
    ...
    draw_graph(module_wrap,input_data=input_data, graph_dir=save_dir, **config)
