...
class BatchwiseSampler:
    def __init__(
        ...
        channels_first : bool
            Whether the data should be in channels_first format or not. If not provided, will be set to None.
        """
...
def indices_batchdomain_constructor(
    indices: list = None, batch_size: int = None
) -> list:
    """
