...
Fire Multifidelity Auto Time Step
"""
...
if train == "yes":
    ...
    saver.write(
        save_dir='./',
        name="adaptative_multifidelity_fire_pinn",
        model=multi_net,
        template=model_,
    )
...
# evaluations
    ...
    saver = SPFile(compact=False)
    multi_net = saver.read(model_path='./adaptative_multifidelity_fire_pinn', device='cpu')
    ...
    # Plot Result
    Charts_Dir= './'
    Chart_File_Name = Charts_Dir + 'Fire_ODE_Multifidelity_PINN_Comparison.png'
