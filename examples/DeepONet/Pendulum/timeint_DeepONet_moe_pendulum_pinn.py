...
def model():
    ...
    branch_net = MoEPool(experts_list=[branch_net_0, branch_net_1,
                                       branch_net_2, branch_net_3],
                         input_size=2, devices='gpu')
...
saver.write(save_dir=save_path, name='pendulum_deeponet_moe', model=pendulum_net, template=model)
