...
class TestLorenzTorch(TestCase):
    ...
    def test_lorenz_torch(self):
        ...
        if batching == 'segmented':
            ...
            batcher = IntersectingBatches(skip_size=10, batch_size=int(delta_t/dt))
        ...
        optimizer = Optimizer('adam', params=optimizer_config, shuffle=False)

        optimizer.fit(op=lorenz_net, input_data=input_data, target_data=output_train, batch_size=batch_size,
