...
if __name__ == "__main__":
    ...
    cases_train_indices = np.random.choice(
        n_cases, n_cases_train, replace=False
    ).tolist()
    ...
    Input_parameters_train = (
        np.tile(input_parameters_train[:, :, None], (1, 1, n_steps))
        .transpose(0, 2, 1)
    ...
    for c in range(n_cases_test):
        ...
        approximated_data = sinoidal_net.eval(
