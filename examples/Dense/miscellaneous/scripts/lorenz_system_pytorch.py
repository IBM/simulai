...
class TestLorenzTorch:
    ...
    def test_lorenz_torch(self):
        ...
        optimizer = Optimizer('adam', params=optimizer_config, early_stopping=False,
                              early_stopping_params={'patience': 10})

        optimizer.fit(op=lorenz_net, input_data=train_input_data, target_data=train_output_data,
                      validation_data=(test_input_data, test_output_data), batch_size=None,
